...
This helm chart has been created using as base template the blue green example in `argoproj/argocd-example-apps` repo.
[link](https://github.com/argoproj/argocd-example-apps)

[This article](https://medium.com/@xpiotrkleban/full-automation-with-argo-rollout-blue-green-deployment-automatic-rollout-abort-and-rollback-54652158fdf4)
has been also used to build this helm chartUsing this
